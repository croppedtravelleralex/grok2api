...
import { DeferredAccountsPage, DeferredApiDocsPage, DeferredAppShell, DeferredClientKeysPage, DeferredDashboardPage, DeferredImageTimelinePage, DeferredMediaImagesPage, DeferredModelsPage, DeferredRequestAuditsPage, DeferredSettingsPage } from "@/app/deferred-pages";
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/media/images", element: <DeferredMediaImagesPage /> },
          { path: "/image-timeline", element: <DeferredImageTimelinePage /> },
