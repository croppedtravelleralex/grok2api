        ...
        <Tabs defaultValue="providers" className="space-y-6">
          ...
          <SettingsSection title={t("settings.web.title")}>
            <div className="grid gap-x-4 gap-y-5 sm:grid-cols-2">
              ...
              <SettingsField controlId="web-web-concurrency" label={t("settings.web.webConcurrency")} badge={t("settings.restartRequired")} error={form.formState.errors.providerWeb?.webConcurrency?.message}><Input id="web-web-concurrency" type="number" min={1} max={20} {...form.register("providerWeb.webConcurrency", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="web-asset-concurrency" label={t("settings.web.assetConcurrency")} badge={t("settings.restartRequired")} error={form.formState.errors.providerWeb?.assetConcurrency?.message}><Input id="web-asset-concurrency" type="number" min={1} max={20} {...form.register("providerWeb.assetConcurrency", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="web-prompt-slots" label={t("settings.web.promptSlots")} badge={t("settings.restartRequired")} error={form.formState.errors.providerWeb?.promptSlots?.message}><Input id="web-prompt-slots" type="number" min={1} max={64} {...form.register("providerWeb.promptSlots", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="web-sse-slots" label={t("settings.web.sseSlots")} badge={t("settings.restartRequired")} error={form.formState.errors.providerWeb?.sseSlots?.message}><Input id="web-sse-slots" type="number" min={1} max={64} {...form.register("providerWeb.sseSlots", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="web-expand-concurrency" label={t("settings.web.expandConcurrency")} badge={t("settings.restartRequired")} error={form.formState.errors.providerWeb?.expandConcurrency?.message}><Input id="web-expand-concurrency" type="number" min={1} max={20} {...form.register("providerWeb.expandConcurrency", { valueAsNumber: true })} /></SettingsField>
