...
export type SettingsConfigDTO = {
  ...
  providerWeb: {
    ...
    mediaConcurrency: number; webConcurrency: number; assetConcurrency: number; allowNSFW: boolean;
...
const settingsConfigValidator = hasShape({
  ...
  providerWeb: hasShape({
    ...
    statsigSignerURL: isString, mediaConcurrency: isNumber, webConcurrency: isNumber, assetConcurrency: isNumber, allowNSFW: isBoolean, recoveryBackoffBase: isString, recoveryBackoffMax: isString,
  }),
