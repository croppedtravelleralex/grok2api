...
type providerWebConfigDTO struct {
	...
	PromptSlots             int    `json:"promptSlots"`
	SSESlots                int    `json:"sseSlots"`
	...
	return settingsResponse{
		Config: settingsConfigDTO{
			...
			ProviderWeb: providerWebConfigDTO{
				...
				AssetConcurrency: config.ProviderWeb.AssetConcurrency, ExpandConcurrency: config.ProviderWeb.ExpandConcurrency,
				PromptSlots: config.ProviderWeb.PromptSlots, SSESlots: config.ProviderWeb.SSESlots, AllowNSFW: config.ProviderWeb.AllowNSFW,
