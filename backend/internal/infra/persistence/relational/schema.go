...
var schemaIndexes = []string{
	...
	"CREATE INDEX IF NOT EXISTS idx_accounts_pool_observed ON provider_accounts(provider, enabled, auth_status, observed_model)",
	...
	"CREATE INDEX IF NOT EXISTS idx_quota_recovery_status_probe ON account_quota_recovery(status, next_probe_at, account_id)",
	"CREATE UNIQUE INDEX IF NOT EXISTS idx_account_pool_snapshots_bucket_provider ON account_pool_snapshots(bucket_at, provider)",
	"CREATE INDEX IF NOT EXISTS idx_account_pool_snapshots_bucket ON account_pool_snapshots(bucket_at DESC, provider)",
	...
	"CREATE INDEX IF NOT EXISTS idx_account_model_states_status ON account_model_states(upstream_model, status, cooldown_until, account_id)",
