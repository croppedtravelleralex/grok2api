...
from chrome_ticket_experiment_lib import panda_image_once, pool_stats, run_remote_python  # noqa: E402
...
def main() -> int:
    ...
    for i in range(1, args.n + 1):
        ...
        print(
            ...
            f"cf={img.get('cf_warm')} aid={img.get('account_id')} wall={img.get('wall_s')}s "
